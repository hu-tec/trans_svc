    ...
    /******************* FILE Delete ***********************/
    $('#STTList').on('click', 'button', function (e) {
    ...
    function Quotation_Section_Open() {
        ...
        if ( isChangeServiceText == 0 ) { 
            $("#Text_Basic").html( "AI STT" );
            $("#Text_Basic").siblings('div .showPopup').html("<p>음성파일을 텍스트로 변경하는 서비스입니다.</p>");

            $("#Text_Standard").html('AI STT <img width="14px" height="14px" src="/img/plus.png"> 휴먼감수');
            $("#Text_Standard").siblings('div .showPopup').html("<p>텍스트파일로 변경한 결과물을 휴먼감수로 정확도를 높입니다.</p>");

            $("#Text_Deluxe").html('AI STT <img width="14px" height="14px" src="/img/plus.png"> 휴먼감수 <img width="14px" height="14px" src="/img/plus.png"> AI 번역');
            $("#Text_Deluxe").siblings('div .showPopup').html("<p>휴먼감수까지 마친 텍스트 파일을 109개 언어으로 AI번역을 합니다.</p>");

            $("#Text_Premium").html('AI STT <img width="14px" height="14px" src="/img/plus.png"> 휴먼감수 <img width="14px" height="14px" src="/img/plus.png"><br>AI 번역 <img width="14px" height="14px" src="/img/plus.png"> 휴먼번역감수' );
