<?php
    ...
    */
	...
	define( "LICENSE_KEY", "ST2105131628068071864" );
    ...
    */
	...
	define( "AES256_KEY", "FKD276c030SR5ONPz2C9t0C4X5521p9s");
    ...
    */
    ...
    define( "PAYMENT_SERVER", "https://npg.settlebank.co.kr");//운영서버 url
    ...
    */
    ...
    define( "CANCEL_SERVER", "https://gw.settlebank.co.kr");//운영서버 url
    ...
    //로그 파일명 및 경로 수정
    define("LOG_DIR", "/var/log/vshop/pg/log");                    //로그 디렉터리(디렉터리가 존재하지 않으면, 로그 파일 생성하지 않습니다.)
